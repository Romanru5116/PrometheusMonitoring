 ...
 * развернута Графана
 * развернут прометеус
 * развернут алерманагер
* развернут node exporter
* развернут procces exporter
* все это проинтегрировано
* выведены дашборды ![](https://github.com/Romanru5116/PrometheusMonitoring/blob/main/PIC%2FScreenshotDasGarafana%20from%202026-07-16%2011-24-26.png)
...
картинка не вставилась, но она есть:
