...
## статус поекта 3107
продолжаем переносить конфиги графаны в git
гипотеза просто перенести всю БД Графаны в Git - неоправдалось - небезопасно
создана директория /data для хранения БД  при разворачивании, изменен конфиг docker-compose
