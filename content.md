#Grafana 
критерии что графана может быть разаернутаna из Git-репозитория на чистый сервер,
1. конфигурация должна отвечать принципам Infrastructure-as-Code и Observability-as-Code:
  2.Все необходимые файлы настроек, дашбордов и источников данных должны храниться в декларативном виде, чтобы новая инсталляция автоматически воссоздала точное состояние системы:
     3.Декларативное описание (Provisioning)Источники данных (Data Sources):
       4.Описаны в YAML-файлах в папке provisioning/datasources/ с указанием типов, URL и параметров аутентификации.Дашборды (Dashboards):
         5.Экспортированы в виде JSON-файлов и структурированы по папкам через YAML-манифесты в provisioning/dashboards/.
